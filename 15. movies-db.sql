...
## TABELA DE RELACIONAMENTO - CARDINALIDADE N PARA N
DROP TABLE IF EXISTS `actor_episode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `actor_episode` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ## DEFAULT - DEFINE UMA INFORMAÇÃO PADRÃO
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `actor_id` int(10) unsigned NOT NULL,
  `episode_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`), ## CHAVE PRIMÁRIA COMPOSTA
  KEY `actor_episode_actor_id_foreign` (`actor_id`), ## POR ESSA
  KEY `actor_episode_episode_id_foreign` (`episode_id`), ## E ESSA
